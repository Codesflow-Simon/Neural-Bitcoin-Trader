...
To get started using Neural Trader, clone the repository onto your machine with python 3.7.
...
run `app.py` with the flag `-w` and specify the config file with `--config example.json`
i.e. `python app.py -w --config example.json`
